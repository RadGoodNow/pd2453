...
config_dcc_gemnoc()
{
    ...
    echo 0x2423A010 1  > $DCC_PATH/config
    echo 0x2423C010 1  > $DCC_PATH/config
...
config_dcc_ddr_nonsecure()
{
    ...
    echo 0x240BA2C0 2 > $DCC_PATH/config
    ...
    echo 0x24845070 4 > $DCC_PATH/config
    ...
    echo 0x2484740C 3 > $DCC_PATH/config
    echo 0x24847448 1 > $DCC_PATH/config
    echo 0x24847450 1 > $DCC_PATH/config
    echo 0x24847458 2 > $DCC_PATH/config
    echo 0x24847600 1 > $DCC_PATH/config
    echo 0x24849000 1 > $DCC_PATH/config
    echo 0x24849010 1 > $DCC_PATH/config
    echo 0x2484D010 1 > $DCC_PATH/config
    echo 0x2484E010 1 > $DCC_PATH/config
    echo 0x2484F010 1 > $DCC_PATH/config
    echo 0x24850010 1 > $DCC_PATH/config
    echo 0x24851010 1 > $DCC_PATH/config
    echo 0x2486400C 2 > $DCC_PATH/config
    echo 0x24864020 1 > $DCC_PATH/config
    echo 0x24864030 1 > $DCC_PATH/config
    echo 0x24864040 1 > $DCC_PATH/config
    echo 0x24868050 1 > $DCC_PATH/config
    echo 0x24868060 1 > $DCC_PATH/config
    echo 0x24868100 7 > $DCC_PATH/config
    echo 0x24868120 5 > $DCC_PATH/config
    echo 0x24868204 1 > $DCC_PATH/config
    ...
    echo 0x2487208C 1 > $DCC_PATH/config
    echo 0x24872098 1 > $DCC_PATH/config
    echo 0x248720B8 3 > $DCC_PATH/config
    echo 0x248720F4 9 > $DCC_PATH/config
    echo 0x24872324 14 > $DCC_PATH/config
    echo 0x24872410 1 > $DCC_PATH/config
    echo 0x24872444 1 > $DCC_PATH/config
    ...
    echo 0x248A6020 3 > $DCC_PATH/config
    echo 0x248A6034 2 > $DCC_PATH/config
    ...
    echo 0x248A6120 1 > $DCC_PATH/config
    echo 0x248A6200 1 > $DCC_PATH/config
    echo 0x248A6214 1 > $DCC_PATH/config
    echo 0x248A7020 1 > $DCC_PATH/config
    echo 0x248A7030 2 > $DCC_PATH/config
    echo 0x248A7078 2 > $DCC_PATH/config
    echo 0x248A7084 1 > $DCC_PATH/config
    echo 0x248A7090 5 > $DCC_PATH/config
    echo 0x248A718C 1 > $DCC_PATH/config
    echo 0x248A71B0 1 > $DCC_PATH/config
    echo 0x248A7204 5 > $DCC_PATH/config
    echo 0x248EA000 1 > $DCC_PATH/config
    echo 0x248EA000 2 > $DCC_PATH/config
    echo 0x248EA004 1 > $DCC_PATH/config
    echo 0x248EA010 1 > $DCC_PATH/config
    echo 0x248EA010 2 > $DCC_PATH/config
    echo 0x248EA014 2 > $DCC_PATH/config
    echo 0x248EA018 1 > $DCC_PATH/config
    echo 0x248EA020 1 > $DCC_PATH/config
    echo 0x248EA020 2 > $DCC_PATH/config
    echo 0x248EA024 2 > $DCC_PATH/config
    echo 0x248EA028 1 > $DCC_PATH/config
    echo 0x248EA030 1 > $DCC_PATH/config
    echo 0x248EA030 2 > $DCC_PATH/config
    echo 0x248EA034 2 > $DCC_PATH/config
    echo 0x248EA038 1 > $DCC_PATH/config
    echo 0x248EA040 1 > $DCC_PATH/config
    echo 0x248EA040 2 > $DCC_PATH/config
    echo 0x248EA044 2 > $DCC_PATH/config
    echo 0x248EA048 1 > $DCC_PATH/config
    echo 0x248EA050 1 > $DCC_PATH/config
    echo 0x248EA050 2 > $DCC_PATH/config
    echo 0x248EA054 2 > $DCC_PATH/config
    ...
    echo 0x24A007E0 1 > $DCC_PATH/config
    ...
    echo 0x24C45070 4 > $DCC_PATH/config
    ...
    echo 0x24C4740C 3 > $DCC_PATH/config
    echo 0x24C47448 1 > $DCC_PATH/config
    echo 0x24C47450 1 > $DCC_PATH/config
    echo 0x24C47458 2 > $DCC_PATH/config
    echo 0x24C47600 1 > $DCC_PATH/config
    echo 0x24C49000 1 > $DCC_PATH/config
    echo 0x24C49010 1 > $DCC_PATH/config
    echo 0x24C4D010 1 > $DCC_PATH/config
    echo 0x24C4E010 1 > $DCC_PATH/config
    echo 0x24C4F010 1 > $DCC_PATH/config
    echo 0x24C50010 1 > $DCC_PATH/config
    echo 0x24C51010 1 > $DCC_PATH/config
    echo 0x24C6801C 8 > $DCC_PATH/config
    echo 0x24C68050 1 > $DCC_PATH/config
    echo 0x24C68060 1 > $DCC_PATH/config
    echo 0x24C68100 7 > $DCC_PATH/config
    echo 0x24C68120 5 > $DCC_PATH/config
    echo 0x24C68204 1 > $DCC_PATH/config
    echo 0x24C68218 1 > $DCC_PATH/config
    echo 0x24C690FC 1 > $DCC_PATH/config
    echo 0x24C6D064 1 > $DCC_PATH/config
    echo 0x24C7203C 14 > $DCC_PATH/config
    echo 0x24C7208C 1 > $DCC_PATH/config
    echo 0x24C72098 1 > $DCC_PATH/config
    echo 0x24C720B8 3 > $DCC_PATH/config
    echo 0x24C720F4 9 > $DCC_PATH/config
    echo 0x24C72324 14 > $DCC_PATH/config
    echo 0x24C72410 1 > $DCC_PATH/config
    echo 0x24C72444 1 > $DCC_PATH/config
    echo 0x24C730A8 1 > $DCC_PATH/config
    echo 0x24C74038 4 > $DCC_PATH/config
    echo 0x24C74060 7 > $DCC_PATH/config
    echo 0x24C79064 1 > $DCC_PATH/config
    echo 0x24CA6020 3 > $DCC_PATH/config
    echo 0x24CA6034 2 > $DCC_PATH/config
    echo 0x24CA6040 1 > $DCC_PATH/config
    echo 0x24CA6058 1 > $DCC_PATH/config
    echo 0x24CA6060 1 > $DCC_PATH/config
    echo 0x24CA6068 2 > $DCC_PATH/config
    echo 0x24CA6120 1 > $DCC_PATH/config
    echo 0x24CA6200 1 > $DCC_PATH/config
    echo 0x24CA6214 1 > $DCC_PATH/config
    echo 0x24CA7020 1 > $DCC_PATH/config
    echo 0x24CA7030 2 > $DCC_PATH/config
    echo 0x24CA7078 2 > $DCC_PATH/config
    echo 0x24CA7084 1 > $DCC_PATH/config
    echo 0x24CA7090 5 > $DCC_PATH/config
    echo 0x24CA718C 1 > $DCC_PATH/config
    echo 0x24CA71B0 1 > $DCC_PATH/config
    echo 0x24CA7204 5 > $DCC_PATH/config
    echo 0x24CEA000 1 > $DCC_PATH/config
    echo 0x24CEA000 2 > $DCC_PATH/config
    echo 0x24CEA004 1 > $DCC_PATH/config
    echo 0x24CEA010 1 > $DCC_PATH/config
    echo 0x24CEA010 2 > $DCC_PATH/config
    echo 0x24CEA014 2 > $DCC_PATH/config
    echo 0x24CEA018 1 > $DCC_PATH/config
    echo 0x24CEA020 1 > $DCC_PATH/config
    echo 0x24CEA020 2 > $DCC_PATH/config
    echo 0x24CEA024 2 > $DCC_PATH/config
    echo 0x24CEA028 1 > $DCC_PATH/config
    echo 0x24CEA030 1 > $DCC_PATH/config
    echo 0x24CEA030 2 > $DCC_PATH/config
    echo 0x24CEA034 2 > $DCC_PATH/config
    echo 0x24CEA038 1 > $DCC_PATH/config
    echo 0x24CEA040 1 > $DCC_PATH/config
    echo 0x24CEA040 2 > $DCC_PATH/config
    echo 0x24CEA044 2 > $DCC_PATH/config
    echo 0x24CEA048 1 > $DCC_PATH/config
    echo 0x24CEA050 1 > $DCC_PATH/config
    echo 0x24CEA050 2 > $DCC_PATH/config
    echo 0x24CEA054 2 > $DCC_PATH/config
    echo 0x24CEA058 1 > $DCC_PATH/config
    echo 0x24E00304 1 > $DCC_PATH/config
    echo 0x24E004BC 1 > $DCC_PATH/config
    echo 0x24E00700 1 > $DCC_PATH/config
    echo 0x24E00708 5 > $DCC_PATH/config
    echo 0x24E00720 1 > $DCC_PATH/config
    echo 0x24E00740 1 > $DCC_PATH/config
    echo 0x24E00748 1 > $DCC_PATH/config
    echo 0x24E007A0 1 > $DCC_PATH/config
    echo 0x24E007B0 3 > $DCC_PATH/config
    echo 0x24E007D0 3 > $DCC_PATH/config
    echo 0x24E007E0 1 > $DCC_PATH/config
    echo 0x24E007F0 2 > $DCC_PATH/config
    ...
    echo 0x25845070 4 > $DCC_PATH/config
    ...
    echo 0x2584740C 3 > $DCC_PATH/config
    echo 0x25847448 1 > $DCC_PATH/config
    echo 0x25847450 1 > $DCC_PATH/config
    echo 0x25847458 2 > $DCC_PATH/config
    echo 0x25847600 1 > $DCC_PATH/config
    echo 0x25849000 1 > $DCC_PATH/config
    echo 0x25849010 1 > $DCC_PATH/config
    echo 0x2584D010 1 > $DCC_PATH/config
    echo 0x2584E010 1 > $DCC_PATH/config
    echo 0x2584F010 1 > $DCC_PATH/config
    echo 0x25850010 1 > $DCC_PATH/config
    echo 0x25851010 1 > $DCC_PATH/config
    echo 0x2586801C 8 > $DCC_PATH/config
    echo 0x25868050 1 > $DCC_PATH/config
    echo 0x25868060 1 > $DCC_PATH/config
    echo 0x25868100 7 > $DCC_PATH/config
    echo 0x25868120 5 > $DCC_PATH/config
    echo 0x25868204 1 > $DCC_PATH/config
    echo 0x25868218 1 > $DCC_PATH/config
    echo 0x258690FC 1 > $DCC_PATH/config
    echo 0x2587203C 14 > $DCC_PATH/config
    echo 0x2587208C 1 > $DCC_PATH/config
    echo 0x25872098 1 > $DCC_PATH/config
    echo 0x258720B8 3 > $DCC_PATH/config
    echo 0x258720F4 9 > $DCC_PATH/config
    echo 0x25872324 14 > $DCC_PATH/config
    echo 0x25872410 1 > $DCC_PATH/config
    echo 0x25872444 1 > $DCC_PATH/config
    echo 0x258730A8 1 > $DCC_PATH/config
    echo 0x25874038 4 > $DCC_PATH/config
    echo 0x25874060 7 > $DCC_PATH/config
    echo 0x25879064 1 > $DCC_PATH/config
    echo 0x258A6020 3 > $DCC_PATH/config
    echo 0x258A6034 2 > $DCC_PATH/config
    echo 0x258A6040 1 > $DCC_PATH/config
    echo 0x258A6058 1 > $DCC_PATH/config
    echo 0x258A6060 1 > $DCC_PATH/config
    echo 0x258A6068 2 > $DCC_PATH/config
    echo 0x258A6120 1 > $DCC_PATH/config
    echo 0x258A6200 1 > $DCC_PATH/config
    echo 0x258A6214 1 > $DCC_PATH/config
    echo 0x258A7020 1 > $DCC_PATH/config
    echo 0x258A7030 2 > $DCC_PATH/config
    echo 0x258A7078 2 > $DCC_PATH/config
    echo 0x258A7084 1 > $DCC_PATH/config
    echo 0x258A7090 5 > $DCC_PATH/config
    echo 0x258A718C 1 > $DCC_PATH/config
    echo 0x258A71B0 1 > $DCC_PATH/config
    echo 0x258A7204 5 > $DCC_PATH/config
    echo 0x258EA000 1 > $DCC_PATH/config
    echo 0x258EA000 2 > $DCC_PATH/config
    echo 0x258EA004 1 > $DCC_PATH/config
    echo 0x258EA010 1 > $DCC_PATH/config
    echo 0x258EA010 2 > $DCC_PATH/config
    echo 0x258EA014 2 > $DCC_PATH/config
    echo 0x258EA018 1 > $DCC_PATH/config
    echo 0x258EA020 1 > $DCC_PATH/config
    echo 0x258EA020 2 > $DCC_PATH/config
    echo 0x258EA024 2 > $DCC_PATH/config
    echo 0x258EA028 1 > $DCC_PATH/config
    echo 0x258EA030 1 > $DCC_PATH/config
    echo 0x258EA030 2 > $DCC_PATH/config
    echo 0x258EA034 2 > $DCC_PATH/config
    echo 0x258EA038 1 > $DCC_PATH/config
    echo 0x258EA040 1 > $DCC_PATH/config
    echo 0x258EA040 2 > $DCC_PATH/config
    echo 0x258EA044 2 > $DCC_PATH/config
    echo 0x258EA048 1 > $DCC_PATH/config
    echo 0x258EA050 1 > $DCC_PATH/config
    echo 0x258EA050 2 > $DCC_PATH/config
    echo 0x258EA054 2 > $DCC_PATH/config
    echo 0x258EA058 1 > $DCC_PATH/config
    echo 0x25A00304 1 > $DCC_PATH/config
    echo 0x25A004BC 1 > $DCC_PATH/config
    echo 0x25A00700 1 > $DCC_PATH/config
    echo 0x25A00708 5 > $DCC_PATH/config
    echo 0x25A00720 1 > $DCC_PATH/config
    echo 0x25A00740 1 > $DCC_PATH/config
    echo 0x25A00748 1 > $DCC_PATH/config
    echo 0x25A007A0 1 > $DCC_PATH/config
    echo 0x25A007B0 3 > $DCC_PATH/config
    echo 0x25A007D0 3 > $DCC_PATH/config
    echo 0x25A007E0 1 > $DCC_PATH/config
    echo 0x25A007F0 2 > $DCC_PATH/config
    ...
    echo 0x25C45070 4 > $DCC_PATH/config
    ...
    echo 0x25C4740C 3 > $DCC_PATH/config
    echo 0x25C47448 1 > $DCC_PATH/config
    echo 0x25C47450 1 > $DCC_PATH/config
    echo 0x25C47458 2 > $DCC_PATH/config
    echo 0x25C47600 1 > $DCC_PATH/config
    echo 0x25C49000 1 > $DCC_PATH/config
    echo 0x25C49010 1 > $DCC_PATH/config
    echo 0x25C4D010 1 > $DCC_PATH/config
    echo 0x25C4E010 1 > $DCC_PATH/config
    echo 0x25C4F010 1 > $DCC_PATH/config
    echo 0x25C50010 1 > $DCC_PATH/config
    echo 0x25C51010 1 > $DCC_PATH/config
    echo 0x25C6801C 8 > $DCC_PATH/config
    echo 0x25C68050 1 > $DCC_PATH/config
    echo 0x25C68060 1 > $DCC_PATH/config
    echo 0x25C68100 7 > $DCC_PATH/config
    echo 0x25C68120 5 > $DCC_PATH/config
    echo 0x25C68204 1 > $DCC_PATH/config
    echo 0x25C68218 1 > $DCC_PATH/config
    echo 0x25C690FC 1 > $DCC_PATH/config
    echo 0x25C7203C 14 > $DCC_PATH/config
    echo 0x25C7208C 1 > $DCC_PATH/config
    echo 0x25C72098 1 > $DCC_PATH/config
    echo 0x25C720B8 3 > $DCC_PATH/config
    echo 0x25C720F4 9 > $DCC_PATH/config
    echo 0x25C72324 14 > $DCC_PATH/config
    echo 0x25C72410 1 > $DCC_PATH/config
    echo 0x25C72444 1 > $DCC_PATH/config
    echo 0x25C730A8 1 > $DCC_PATH/config
    echo 0x25C74038 4 > $DCC_PATH/config
    echo 0x25C74060 7 > $DCC_PATH/config
    echo 0x25C79064 1 > $DCC_PATH/config
    echo 0x25CA6020 3 > $DCC_PATH/config
    echo 0x25CA6034 2 > $DCC_PATH/config
    echo 0x25CA6040 1 > $DCC_PATH/config
    echo 0x25CA6058 1 > $DCC_PATH/config
    echo 0x25CA6060 1 > $DCC_PATH/config
    echo 0x25CA6068 2 > $DCC_PATH/config
    echo 0x25CA6120 1 > $DCC_PATH/config
    echo 0x25CA6200 1 > $DCC_PATH/config
    echo 0x25CA6214 1 > $DCC_PATH/config
    echo 0x25CA7020 1 > $DCC_PATH/config
    echo 0x25CA7030 2 > $DCC_PATH/config
    echo 0x25CA7078 2 > $DCC_PATH/config
    echo 0x25CA7084 1 > $DCC_PATH/config
    echo 0x25CA7090 5 > $DCC_PATH/config
    echo 0x25CA718C 1 > $DCC_PATH/config
    echo 0x25CA71B0 1 > $DCC_PATH/config
    echo 0x25CA7204 5 > $DCC_PATH/config
    echo 0x25CEA000 2 > $DCC_PATH/config
    echo 0x25CEA010 2 > $DCC_PATH/config
    echo 0x25CEA018 1 > $DCC_PATH/config
    echo 0x25CEA020 2 > $DCC_PATH/config
    echo 0x25CEA028 1 > $DCC_PATH/config
    echo 0x25CEA030 2 > $DCC_PATH/config
    echo 0x25CEA038 1 > $DCC_PATH/config
    echo 0x25CEA040 2 > $DCC_PATH/config
    echo 0x25CEA048 1 > $DCC_PATH/config
    echo 0x25CEA050 2 > $DCC_PATH/config
    echo 0x25CEA058 1 > $DCC_PATH/config
    echo 0x25E00304 1 > $DCC_PATH/config
    echo 0x25E004BC 1 > $DCC_PATH/config
    echo 0x25E00700 1 > $DCC_PATH/config
    echo 0x25E00708 5 > $DCC_PATH/config
    echo 0x25E00720 1 > $DCC_PATH/config
    echo 0x25E00740 1 > $DCC_PATH/config
    echo 0x25E00748 1 > $DCC_PATH/config
    echo 0x25E007A0 1 > $DCC_PATH/config
    echo 0x25E007B0 3 > $DCC_PATH/config
    echo 0x25E007D0 3 > $DCC_PATH/config
    echo 0x25E007E0 1 > $DCC_PATH/config
    echo 0x25E007F0 2 > $DCC_PATH/config
}
